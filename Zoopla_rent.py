...
class Zoopla_listings:
    ...
    def property_download(self):
        url_base = 'http://api.zoopla.co.uk/api/v1/property_listings.js?' + '&page_number=' + str(self.page_number) + '&area=' + self.city_name + '&page_size=100&listing_status=rent&&api_key=z7cyp8jsb3enyxxfvvs8s8fn'
